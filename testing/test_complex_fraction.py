...
def test_sub(complex_num, real_num):
    ...
    assert complex_num - real_num == ComplexFraction('1/3', '-1/4') - ComplexFraction('5/2', '0')

def test_mul(complex_num):

    assert complex_num * ComplexFraction(1,1) == ComplexFraction('1/3', '-1/4') + ComplexFraction('1/4', '1/3')
